...
router.post('/', (req, res) => {
    ...
    const queryTextUpsert = `INSERT INTO intake (patient_id, weight_kg, length_m, bmi_auto, crp, ca125, leucocyte, smoking, diabetes, insulin_dependant, cardiovascular, hypertension,
        ...
        DO UPDATE SET weight_kg=$2, length_m=$3, bmi_auto=$4,
            ...
            insulin_dependant=$10, cardiovascular=$11, hypertension=$12, stoma_pre_hipec=$13, stoma_type=$14, neo_adjuvant_chemo=$15,
        ...
        pool.query(queryTextUpsert, [patientId, userInfo.weight_kg, userInfo.length_m, userInfo.bmi_auto,
            ...
            userInfo.insulin_dependant, userInfo.cardiovascular, userInfo.hypertension, 'NULL', 'NULL', userInfo.neo_adjuvant_chemo,
